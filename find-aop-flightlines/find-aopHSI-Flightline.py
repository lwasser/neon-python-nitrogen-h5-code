...
This script takes a shapefile polygon extent and looks for the flightline that it
intersects with
@author: law
"""
#import libraries that Python needs to read shapefiles
# note - you have to install shapefile via pip install pyshp
import shapefile
import h5py 
import numpy as np
...
plotBoundariesPath=(r'H:\1_Data-Institute-subsets\D17-California\SOAP\vector_data\soap_clip_extent.shp')
